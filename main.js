...
function validComment(){
 ...
 return true;
  ...
  function validation(){
    if (!validName() || !validMail() || !validPhone() || !validComment() == true){
      swal("please check your information", "", "error", {  buttons: ["cancel", true],
});
    }
    else{
      swal("your information has been submited", "", "success");
